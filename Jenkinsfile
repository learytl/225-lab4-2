pipeline {
    ...
    environment {
        ...
        GITHUB_URL = 'https://github.com/learytl/225-lab5-1.git'     //<-----change this to match this new repository!
        ...
        stage ("Run Security Checks") {
            steps {
                ...
                sh '''
                    ...
                    -e HOME=${WORKSPACE} \
                    -e BURP_START_URL=http://10.48.229.146 \
    ...
    post {
        ...
        failure {
            slackSend color: "danger", message: "Build Lab 5.1 FAILURE: ${env.JOB_NAME} ${env.BUILD_NUMBER}"
        }
    }
}
